	...
	public class 다리만들기2 {
		...
		static PriorityQueue<edge> pq = new PriorityQueue<edge>(new edgeComparator()); 
		...
		public static void main(String[] args) 
		{
			...
			for(int i=0; i<N; i++)
			{
				...
				{	
					...
					int tk = Map[i][j]; // 값을 넣어준다. 
					for(int idx=0; idx<4; idx++)
					{
						int nx = i+ dx[idx];
						int ny = j+ dy[idx];
						if( !boundary(nx,ny)) continue;
						if( Map[nx][ny] == tk) continue;  
						int td = 0;
						while(true)
						{
